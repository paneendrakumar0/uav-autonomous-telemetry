...
- `samples`: `3705`
- `duration_s`: `74.0836`
- `mean_3d_error_m`: `0.3387`
- `rms_3d_error_m`: `0.3539`
- `max_3d_error_m`: `0.5755`
- `mean_xy_error_m`: `0.3385`
- `mean_z_ned_m`: `-4.9945`
- `max_abs_position_m`: `5.0167`
- `swing_valid`: `True`
...
- `max_lateral_swing_m`: `0.6742`
- `mean_cable_angle_deg`: `31.1145`
- `max_cable_angle_deg`: `42.2959`
- `profile`: `geometric`
- `launch_file`: `geometric_figure8_experiment.launch.py`
- `tracking_valid`: `True`
- `tracking_reason`: `valid tracking telemetry`
- `output_dir`: `reports/repeatability_validation_2026-07-21/geometric_trial_02`
