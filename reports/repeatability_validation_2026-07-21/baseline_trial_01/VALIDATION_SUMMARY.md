...
- `samples`: `3709`
- `duration_s`: `74.1643`
- `mean_3d_error_m`: `0.4446`
- `rms_3d_error_m`: `0.4749`
- `max_3d_error_m`: `0.6743`
- `mean_xy_error_m`: `0.4443`
- `mean_z_ned_m`: `-4.9989`
- `max_abs_position_m`: `5.3871`
- `swing_valid`: `True`
...
- `mean_cable_angle_deg`: `34.5947`
- `max_cable_angle_deg`: `46.8298`
- `profile`: `baseline`
- `launch_file`: `figure8_payload_experiment.launch.py`
- `tracking_valid`: `True`
- `tracking_reason`: `valid tracking telemetry`
- `output_dir`: `reports/repeatability_validation_2026-07-21/baseline_trial_01`
