...
- `samples`: `3723`
- `duration_s`: `74.4441`
- `mean_3d_error_m`: `0.3354`
- `rms_3d_error_m`: `0.3514`
- `max_3d_error_m`: `0.5985`
- `mean_xy_error_m`: `0.3352`
- `mean_z_ned_m`: `-4.9945`
...
- `max_lateral_swing_m`: `0.6718`
- `mean_cable_angle_deg`: `31.0947`
- `max_cable_angle_deg`: `42.1168`
- `profile`: `geometric`
- `launch_file`: `geometric_figure8_experiment.launch.py`
- `world`: `payload_crosswind_y0`
- `tracking_valid`: `True`
- `tracking_reason`: `valid tracking telemetry`
- `output_dir`: `/home/paneendra/uav-autonomous-telemetry/reports/wind_envelope_validation_2026-07-25/crosswind_y0_geometric`
