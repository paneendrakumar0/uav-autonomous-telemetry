...
- `samples`: `3722`
- `duration_s`: `74.4278`
- `mean_3d_error_m`: `0.4460`
- `rms_3d_error_m`: `0.4760`
- `max_3d_error_m`: `0.6711`
- `mean_xy_error_m`: `0.4456`
- `mean_z_ned_m`: `-4.9984`
- `max_abs_position_m`: `5.3944`
...
- `mean_cable_angle_deg`: `34.5531`
- `max_cable_angle_deg`: `46.8378`
- `profile`: `baseline`
- `launch_file`: `figure8_payload_experiment.launch.py`
- `tracking_valid`: `True`
- `tracking_reason`: `valid tracking telemetry`
- `output_dir`: `reports/repeatability_validation_10x10_2026-07-22/baseline_trial_06`
