...
- `samples`: `3722`
- `duration_s`: `74.4280`
- `mean_3d_error_m`: `0.4915`
- `rms_3d_error_m`: `0.5236`
- `max_3d_error_m`: `0.7357`
- `mean_xy_error_m`: `0.4911`
- `mean_z_ned_m`: `-4.9984`
- `max_abs_position_m`: `5.4342`
...
- `max_lateral_swing_m`: `0.7308`
- `mean_cable_angle_deg`: `34.6221`
- `max_cable_angle_deg`: `46.8178`
- `profile`: `baseline`
- `launch_file`: `figure8_payload_experiment.launch.py`
- `tracking_valid`: `True`
- `tracking_reason`: `valid tracking telemetry`
- `output_dir`: `/home/paneendra/uav-autonomous-telemetry/reports/payload_parameter_sweep_2026-07-22/mass_m100_l100_baseline`
