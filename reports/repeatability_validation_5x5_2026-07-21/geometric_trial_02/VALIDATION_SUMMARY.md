...
- `samples`: `3722`
- `duration_s`: `74.4277`
- `mean_3d_error_m`: `0.3398`
- `rms_3d_error_m`: `0.3549`
- `max_3d_error_m`: `0.5748`
- `mean_xy_error_m`: `0.3396`
- `mean_z_ned_m`: `-4.9951`
- `max_abs_position_m`: `5.0184`
...
- `max_lateral_swing_m`: `0.6738`
- `mean_cable_angle_deg`: `31.1158`
- `max_cable_angle_deg`: `42.2667`
- `profile`: `geometric`
- `launch_file`: `geometric_figure8_experiment.launch.py`
- `tracking_valid`: `True`
- `tracking_reason`: `valid tracking telemetry`
- `output_dir`: `reports/repeatability_validation_5x5_2026-07-21/geometric_trial_02`
