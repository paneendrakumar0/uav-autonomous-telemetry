...
- `samples`: `3721`
- `duration_s`: `74.4035`
- `mean_3d_error_m`: `0.4473`
- `rms_3d_error_m`: `0.4771`
- `max_3d_error_m`: `0.6744`
- `mean_xy_error_m`: `0.4469`
- `mean_z_ned_m`: `-4.9988`
- `max_abs_position_m`: `5.3936`
...
- `mean_cable_angle_deg`: `34.6091`
- `max_cable_angle_deg`: `46.8846`
- `profile`: `baseline`
- `launch_file`: `figure8_payload_experiment.launch.py`
- `tracking_valid`: `True`
- `tracking_reason`: `valid tracking telemetry`
- `output_dir`: `reports/repeatability_validation_5x5_2026-07-21/baseline_trial_03`
