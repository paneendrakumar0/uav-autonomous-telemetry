...
- `samples`: `3723`
- `duration_s`: `74.4439`
- `mean_3d_error_m`: `0.3374`
- `rms_3d_error_m`: `0.3534`
- `max_3d_error_m`: `0.5887`
- `mean_xy_error_m`: `0.3372`
- `mean_z_ned_m`: `-4.9947`
- `max_abs_position_m`: `5.0177`
...
- `mean_lateral_swing_m`: `0.5142`
- `max_lateral_swing_m`: `0.6727`
- `mean_cable_angle_deg`: `31.1179`
- `max_cable_angle_deg`: `42.1845`
- `profile`: `geometric`
- `launch_file`: `geometric_figure8_experiment.launch.py`
- `tracking_valid`: `True`
- `tracking_reason`: `valid tracking telemetry`
- `output_dir`: `reports/repeatability_validation_5x5_2026-07-21/geometric_trial_01`
