...
- `samples`: `3722`
- `duration_s`: `74.4194`
- `mean_3d_error_m`: `0.3375`
- `rms_3d_error_m`: `0.3534`
- `max_3d_error_m`: `0.5940`
- `mean_xy_error_m`: `0.3373`
- `mean_z_ned_m`: `-4.9948`
- `max_abs_position_m`: `5.0183`
...
- `mean_lateral_swing_m`: `0.5143`
- `max_lateral_swing_m`: `0.6735`
- `mean_cable_angle_deg`: `31.1274`
- `max_cable_angle_deg`: `42.2470`
- `profile`: `geometric`
- `launch_file`: `geometric_figure8_experiment.launch.py`
- `tracking_valid`: `True`
- `tracking_reason`: `valid tracking telemetry`
- `output_dir`: `reports/repeatability_validation_5x5_2026-07-21/geometric_trial_05`
