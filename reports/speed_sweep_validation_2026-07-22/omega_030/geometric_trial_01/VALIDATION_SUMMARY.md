...
- `samples`: `3710`
- `duration_s`: `74.1873`
- `mean_3d_error_m`: `0.3842`
- `rms_3d_error_m`: `0.4008`
- `max_3d_error_m`: `0.6504`
- `mean_xy_error_m`: `0.3840`
- `mean_z_ned_m`: `-4.9978`
- `max_abs_position_m`: `5.0229`
...
- `mean_lateral_swing_m`: `0.5849`
- `max_lateral_swing_m`: `0.7446`
- `mean_cable_angle_deg`: `36.0347`
- `max_cable_angle_deg`: `47.9892`
- `profile`: `geometric`
- `launch_file`: `geometric_figure8_experiment.launch.py`
- `tracking_valid`: `True`
- `tracking_reason`: `valid tracking telemetry`
- `output_dir`: `reports/speed_sweep_validation_2026-07-22/omega_030/geometric_trial_01`
