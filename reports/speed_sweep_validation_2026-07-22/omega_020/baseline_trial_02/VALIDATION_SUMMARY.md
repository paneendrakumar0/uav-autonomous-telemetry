...
- `samples`: `3708`
- `duration_s`: `74.1481`
- `mean_3d_error_m`: `0.2834`
- `rms_3d_error_m`: `0.3016`
- `max_3d_error_m`: `0.4921`
- `mean_xy_error_m`: `0.2830`
- `mean_z_ned_m`: `-5.0007`
- `max_abs_position_m`: `5.2201`
...
- `max_lateral_swing_m`: `0.6224`
- `mean_cable_angle_deg`: `27.7597`
- `max_cable_angle_deg`: `38.4240`
- `profile`: `baseline`
- `launch_file`: `figure8_payload_experiment.launch.py`
- `tracking_valid`: `True`
- `tracking_reason`: `valid tracking telemetry`
- `output_dir`: `reports/speed_sweep_validation_2026-07-22/omega_020/baseline_trial_02`
