...
- `samples`: `3710`
- `duration_s`: `74.1800`
- `mean_3d_error_m`: `0.3372`
- `rms_3d_error_m`: `0.3529`
- `max_3d_error_m`: `0.5969`
- `mean_xy_error_m`: `0.3369`
- `mean_z_ned_m`: `-4.9944`
- `max_abs_position_m`: `5.0205`
...
- `mean_lateral_swing_m`: `0.5150`
- `max_lateral_swing_m`: `0.6758`
- `mean_cable_angle_deg`: `31.1707`
- `max_cable_angle_deg`: `42.4207`
- `profile`: `geometric`
- `launch_file`: `geometric_figure8_experiment.launch.py`
- `tracking_valid`: `True`
- `tracking_reason`: `valid tracking telemetry`
- `output_dir`: `reports/speed_sweep_validation_2026-07-22/omega_025/geometric_trial_03`
