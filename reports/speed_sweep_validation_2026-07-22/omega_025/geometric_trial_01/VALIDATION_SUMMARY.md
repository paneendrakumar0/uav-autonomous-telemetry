...
- `samples`: `3709`
- `duration_s`: `74.1646`
- `mean_3d_error_m`: `0.3395`
- `rms_3d_error_m`: `0.3549`
- `max_3d_error_m`: `0.5810`
- `mean_xy_error_m`: `0.3393`
- `mean_z_ned_m`: `-4.9947`
- `max_abs_position_m`: `5.0211`
...
- `max_lateral_swing_m`: `0.6763`
- `mean_cable_angle_deg`: `31.1408`
- `max_cable_angle_deg`: `42.4654`
- `profile`: `geometric`
- `launch_file`: `geometric_figure8_experiment.launch.py`
- `tracking_valid`: `True`
- `tracking_reason`: `valid tracking telemetry`
- `output_dir`: `reports/speed_sweep_validation_2026-07-22/omega_025/geometric_trial_01`
