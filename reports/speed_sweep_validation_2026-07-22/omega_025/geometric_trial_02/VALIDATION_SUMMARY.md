...
- `samples`: `3709`
- `duration_s`: `74.1642`
- `mean_3d_error_m`: `0.3393`
- `rms_3d_error_m`: `0.3549`
- `max_3d_error_m`: `0.5826`
- `mean_xy_error_m`: `0.3391`
- `mean_z_ned_m`: `-4.9949`
- `max_abs_position_m`: `5.0216`
- `mean_altitude_error_m`: `0.0051`
- `swing_valid`: `True`
...
- `mean_cable_angle_deg`: `31.1444`
- `max_cable_angle_deg`: `42.3095`
- `profile`: `geometric`
- `launch_file`: `geometric_figure8_experiment.launch.py`
- `tracking_valid`: `True`
- `tracking_reason`: `valid tracking telemetry`
- `output_dir`: `reports/speed_sweep_validation_2026-07-22/omega_025/geometric_trial_02`
