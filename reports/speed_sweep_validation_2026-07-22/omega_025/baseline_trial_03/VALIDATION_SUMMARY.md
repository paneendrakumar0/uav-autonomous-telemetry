...
- `rms_3d_error_m`: `0.4757`
- `max_3d_error_m`: `0.6788`
- `mean_xy_error_m`: `0.4450`
- `mean_z_ned_m`: `-4.9990`
- `max_abs_position_m`: `5.3898`
...
- `mean_cable_angle_deg`: `34.5977`
- `max_cable_angle_deg`: `46.8243`
- `profile`: `baseline`
- `launch_file`: `figure8_payload_experiment.launch.py`
- `tracking_valid`: `True`
- `tracking_reason`: `valid tracking telemetry`
- `output_dir`: `reports/speed_sweep_validation_2026-07-22/omega_025/baseline_trial_03`
